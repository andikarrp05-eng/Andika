...
<div style="text-align: center; padding: 20px 0; color: rgba(255,255,255,0.4); font-size: 0.85em;">
    <p style="margin: 0;">🌍 <b>SeismoTrack Indonesia</b> v4.0 — Satellite Enhanced Edition</p>
    <p style="margin: 4px 0 0 0;">BMKG Realtime • Citra Satelit HD • Notifikasi & Alarm • Multi-Mode Peta • Streamlit</p>
</div>
""", unsafe_allow_html=True)
